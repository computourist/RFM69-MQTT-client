...
//
//	72 - 90		Special devices not implemented in gateway (yet)
//
...
// version 2.0 - increased payload size; standard device types; trim float values; uptime & version function gateway.
//	
