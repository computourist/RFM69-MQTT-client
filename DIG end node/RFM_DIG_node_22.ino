// RFM69 DIG node sketch
//
// This node talks to the MQTT-Gateway and will control a digital output (LED, Relay):
// - toggle output and send status message on local button push
// - receive commands from the gateway to control output
...
//
// Sensors and outputs can be added easily.
//
...
#define VERSION "DIG V2.2"				// this value can be queried as device 3
